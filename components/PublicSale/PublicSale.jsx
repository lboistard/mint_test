...
const PublicSale = (props) => {
    ...
    const saleStartTime = 1647991260 + 24 * 3600;
                                            ...
                                            <Flex p="2rem" align="center" direction={["column", "column", "row", "row"]}>
                                                <Flex width={["100%", "100%", "50%", "50%"]} align="center" direction="column">
                                                    ...
                                                    <Text fontSize={["1.5rem", "1.5rem", "2rem", "3rem"]}>
                                                        ...
                                                        <chakra.span fontWeight="bold" color="orange">{props.totalSupply} / 5455</chakra.span>
                                                    </Text>
                                                    <Text fontSize="1.5rem">
                                                        <chakra.span fontWeight="bold">Price : </chakra.span>
                                                        <chakra.span color="orange" fontWeight="bold">{props.publicSalePrice} Eth </chakra.span>/ NFT
                                                    </Text>
                                                    <Flex mt="2rem">
                                                        <Button colorScheme="orange" onClick={() => mint(1)} ml="1rem" mr="1rem">
                                                            Buy 1
                                                        </Button>
                                                        <Button colorScheme="orange" onClick={() => mint(2)} ml="1rem" mr="1rem">
                                                            Buy 2
                                                        </Button>
                                                        <Button colorScheme="orange" onClick={() => mint(3)} ml="1rem" mr="1rem">
                                                            Buy 3
                                                        </Button>
                                                    </Flex>
                                                </Flex>
